...
import csv
import os
from src.main import load_json, load_csv, process_bank_search
...
def setup_and_teardown():
    ...
    json_data = [
        {"date": "2023-01-01", "description": "Test transaction 1", "amount": 100, "currency": "USD", "status": "EXECUTED"},
        {"date": "2023-01-02", "description": "Test transaction 2", "amount": 200, "currency": "EUR", "status": "CANCELED"},
    ]
