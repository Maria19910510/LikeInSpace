from src.transaction_helpers import process_bank_operations, process_bank_search
...
def test_process_bank_search_handles_missing_description():
    data = [{"id": 1, "description": "Payment to electricity bill"}, {"id": 2}, {"id": 3, "description": None}]
    result = process_bank_search(data, "payment")
...
def test_process_bank_operations_no_matches():
    data = [{"description": "Rent payment"}, {"description": "Insurance premium"}]
